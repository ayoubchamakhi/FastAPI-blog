...
async def login_for_access_token(
    ...
    # Verifiy password correct
    # Don't reveal which failed (security)
...
async def update_user(
    ...
    if user_id != current_user.id:
        raise HTTPException(
            ...
            detail="Not autorized to update this user.",
        )
...
async def delete_user(
    ...
    if user_id != current_user.id:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Not autorized to delete this user.",
        )
